...
_CONFIGS = [
    ...
    # Pi 0.5 DROID - Full Finetune on DROID 100 - DROID (Original) Norm Stats
    TrainConfig(
        name="pi05droid-full-d100",
    ...
    # Pi 0.5 DROID - Full Finetune on DROID-100 + Toys - DROID (Original) Norm Stats
    TrainConfig(
        name="pi05droid-full-d100+toys",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/d100_toys20",
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(
                assets_dir="gs://openpi-assets/checkpoints/pi05_droid/assets",
                asset_id="droid",
    ...
    # Pi 0.5 DROID - LORA Finetune on DROID-100 + Toys - DROID (Original) Norm Stats
    TrainConfig(
        name="pi05droid-lora-d100+toys",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=16,
    ...
    # Base - Full Finetune on DROID-100 - Own Norm Stats
    TrainConfig(
        name="pi05base-full-d100",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/d100",
            base_config=DataConfig(prompt_from_task=True),
    ...
    # Base - Full Finetune on DROID-100 + Toys - Own Norm Stats
    TrainConfig(
        name="pi05base-full-d100+toys",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/d100_toys20",
            base_config=DataConfig(prompt_from_task=True),
    ...
    # Base - Full Finetune on Toys 100 (Sim) - Own Norm Stats
    TrainConfig(
        name="pi05base-toys100sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/toys100_sim",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
        num_train_steps=20_000,
    ...
    # Pi 0.5 DROID - Full Finetune on Toys 100 (Sim) - DROID (Original) Norm Stats
    TrainConfig(
        name="pi05droid-toys100sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/toys100_sim",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05base-full-d100+toys100sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/d100_toys100_sim",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
        num_train_steps=20_000,
    ...
    # Same streamed base-model DROID + Toys mixture, for the VAE-manifold-cost, RND-novelty-cost, and
    # combined VAE+RND cuTAMP Toys 300 sim sets. Full DROID (lerobot/droid_1.0.1) streams with the
    ...
    TrainConfig(
        name="pi05droid-full-d100+toys100sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/d100_toys100_sim",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05base-toys20sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/toys20_sim",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
        num_train_steps=20_000,
    ...
    # Pi 0.5 DROID - Full Finetune on Toys 20 (Sim) - DROID (Original) Norm Stats
    TrainConfig(
        name="pi05droid-toys20sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/toys20_sim",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi05base-full-d100+toys20sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/d100_toys20_sim",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
        num_train_steps=20_000,
    ...
    TrainConfig(
        name="pi05droid-full-d100+toys20sim",
        model=pi0_config.Pi0Config(pi05=True, action_dim=32, action_horizon=16),
        data=LeRobotDROIDDataConfig(
            repo_id="SamratSahoo/d100_toys20_sim",
            base_config=DataConfig(prompt_from_task=True),
